...
try:
    ...
    # Total iterations
    final_iter = 11136 # (For 49 Epochs, combined dataset based models)
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'Model_combined_49_epochs/trained_model') ### To save model with the name specified in this line
...
plt.savefig("./combined_49_epochs.png")
