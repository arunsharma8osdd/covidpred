...
try:
    ...
    # Total iterations
    final_iter = 400 # (For 24 Epochs, original or single augmentation based models)
    ...
    train_path=r'train_original' # Training Dataset Path to Train model on Original images
    #train_path=r'train_augmented_rotate_120' # Augmented Dataset Path to Train model on Augmented images
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'Model_original_24_epochs/trained_model') ### To save model with the name specified in this line
...
## Graph Title 
plt.title("Original images based model [24 epochs based]")
...
plt.savefig("./original_24_epochs.png")
