...
for vrty in all_varities:
    ...
    train_p = './train_original_all_augmented_images'	

    # Validation set images directory path
    test_p = './test_original_images/'+vrty
    #test_p = './test_augmented_rotate_120_images/'+vrty
	#test_p = './test_original_all_augmented_images/'+vrty


    # Saved model directory path
    model_p = 'Model_combined_101_epochs'    
