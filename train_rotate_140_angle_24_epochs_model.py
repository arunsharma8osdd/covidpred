...
try:
    ...
    # Total iterations
    final_iter = 400 # (For 24 Epochs, 140 degree rotated images based models)
    ...
    train_path=r'train_augmented_rotated_140' # Augmented Dataset Path to Train model on 140 degree rotated (augmented) images
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'Model_rotated_140_degree_24_epochs/trained_model') ### To save model with the name specified in this line
...
## Graph Title 
plt.title("Rotated 140 degree images based model [24 epochs based]")
...
plt.savefig("./rotated_140_degree_24_epochs.png")
