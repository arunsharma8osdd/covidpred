...
try:
    ...
    # Total iterations
    final_iter = 5568 # (For 24 Epochs, combined dataset based models)
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'Model_combined_24_epochs/trained_model') ### To save model with the name specified in this line
...
## Graph Title 
plt.title("Combined images based model [24 epochs based]")
...
plt.savefig("./combined_24_epochs.png")
